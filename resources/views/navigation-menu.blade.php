<nav x-data="{ open: false }" class="bg-fuse-dk-teal border-b text-white border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-nav.responsive-link href="{{ route('challenges') }}" :active="request()->routeIs('challenges')">
                {{ __('Challenges') }}
            </x-nav.responsive-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-nav.responsive-link href="{{ route('help_finder') }}" :active="request()->routeIs('help_finder')">
                {{ __('Help Finder') }}
            </x-nav.responsive-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-nav.responsive-link href="{{ route('gallery') }}" :active="request()->routeIs('gallery')">
                {{ __('My Stuff') }}
            </x-nav.responsive-link>
        </div>
        @if (Auth::user()->is_facilitator() || Auth::user()->is_admin())
