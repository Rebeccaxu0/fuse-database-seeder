<div class="relative">
    <input id="school_search" name="school_search" type="text" class="form-input mt-1 block w-full rounded"
        placeholder="Search schools&hellip;" value="{{ $query }}" wire:keydown.enter.prevent=""
