    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div>
                        <span class="font-bold">{{ __('Start:') }}</span> {{ $announcement->start_at->format('g:i A l, F dS, Y') }}
                    </div>
                    <div>
                        <span class="font-bold">{{ __('End:') }}</span> {{ $announcement->end_at->format('g:i A l, F dS, Y') }}
                    </div>
                    <div>
