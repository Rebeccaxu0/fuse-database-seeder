<x-app-layout>
    ...
    <form class="mt-6" action="{{ route('admin.announcements.store') }}" method="POST">
        ...
        <fieldset class="border border-black p-2">
            ...
            <div class="flex">
                <div class="mr-4">
                    ...
                    <label for="newtype" class="py-1 px-3 text-white rounded-xl announcement-tag new">New</label>
                </div>
                <div class="mr-4">
                    <input type="radio"
                           id="updatetype"
                    ...
                    <label for="updatetype" class="py-1 px-3 text-white rounded-xl announcement-tag update">Update</label>
                </div>
                <div class="mr-4">
                    <input type="radio"
                           id="alerttype"
                    ...
                    <label for="alerttype" class="py-1 px-3 text-white rounded-xl announcement-tag alert">Alert</label>
                </div>
            </div>
        </fieldset>
        ...
        <div>
            <label class="mt-2 block" for="url">URL (optional)</label>
        ...
        <x-form.textarea label="Message *" name="message" :value="old('message', $announcement->body)" />

        <div class="flex flex-wrap mt-4 -mx-3 mb-2">
            <button type="submit"
                class="text-md h-12 px-6 m-2 bg-fuse-green rounded-lg text-white"
                id="btn-submit">Save New Announcement</button>
        </div>
    </form>
