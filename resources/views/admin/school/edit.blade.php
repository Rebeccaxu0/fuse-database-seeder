<x-admin-layout>
    ...
    <form class="w-full max-w-lg mt-6" action="{{ route('admin.schools.update', $school) }}" method="POST">
        ...
        <div x-data="{active: true}">
            ...
            <span class="mx-2 text-xs text-gray-700">Unchecking this will deactivate all studios in the school and move
                all associated students/facilitators into the Alumni Studio.</span><br>
            ...
            <span class="mx-2 text-xs text-gray-700 " :class="{ 'text-gray-400': active}">WARNING: This is a destructive
                operation and cannot be undone.</span><br>
        </div>
