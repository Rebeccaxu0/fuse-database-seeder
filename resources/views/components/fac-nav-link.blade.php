...
<li
    {{ $attributes->merge(['class' => 'flex-1 py-4 md:p-0 m-0 list-none border-t md:border-t-0 md:border-r border-white max-w-none' . (request()->routeIs($route) ? ' bg-fuse-nav-green' : '')]) }}>
    <a href="{{ route($route) }}"
