<div class="border-b border-zinc-300 pr-2">
    <ul class="m-0 p-0 text-right">
        <li class="m-0 mr-2 p-0 inline-block border-zinc-300 border border-b-0 rounded-t-xl relative
            @if (request()->routeIs('student.challenges')) -mb-[1px] bg-neutral-100 @endif
        ">
        @if (request()->routeIs('student.challenges'))
        <x-icon icon="challenge-gallery" width=60 height=60
                fill="currentColor"
                title="{{ __('Challenge Gallery') }}"
        ...
        <li class="m-0 mr-2 p-0 inline-block border-zinc-300 border border-b-0 rounded-t-xl relative
            ...
            <x-icon icon="idea" width=60 height=60
                    fill="currentColor"
                    title="{{ __('Ideas') }}"
                    alt="{{ __('Ideas') }}"
        ...
        <li class="m-0 p-0 inline-block border-zinc-300 border border-b-0 rounded-t-xl relative
            ...
            <x-icon icon="help-finder" width=60 height=60
                    fill="currentColor"
                    title="{{ __('Help Finder') }}"
                    alt="{{ __('Help Finder') }}" class="inline text-orange-500"/>
            <div class="absolute bg-neutral-100 w-full h-1 bottom">&nbsp;</div>
            @else
